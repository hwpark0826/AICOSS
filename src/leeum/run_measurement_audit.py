...
def run() -> dict[str, object]:
    ...
    registry = pd.DataFrame([
        ...
        {"artifact": "neighbor_aggregate.csv", "metric_type": "candidate-area aggregate index", "time_or_base": "2022=100", "aggregation_or_denominator": "sum over selected neighbor areas before index construction", "allowed_interpretation": "descriptive divergence from this selected aggregate", "not_allowed": "per-area average effect or proven spatial displacement"},
