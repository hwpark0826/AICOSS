...
| H2_itaewon_external_shock | A sustained post-2022Q4 fall, especially visitor-oriented weekend/evening demand and neighbouring areas | post/pre sales mean change -23.6%; event date is verified | The official event date falls in 2022Q4 | No visitor origin, exposure intensity, or causal control is available; break timing can reflect concurrent changes | not_verifiable | low |
| H3_spatial_reallocation | Leeum falls while independent nearby areas or same industries rise | 2025 index: Leeum 58.1, independent-neighbour equal-weight mean 95.4 | Independent-area indices diverge descriptively after removing the verified overlapping tourism-zone candidate | No movement paths, store-address transitions, or origin-destination data; an equal-weight comparison is not evidence of transfer | possible | low |
...
| H5_industry_recomposition | Total stores are stable but industry shares/turnover change | 2022→2025 stores 4.7%; every observed industry has lower sales: 일식음식점, 커피-음료, 한식음식점, 양식음식점 | Total average store count is broadly stable | All observed industries decline and there is no business/address identifier to observe replacement | not_supported | medium |
...
| final_classification |  | existing rank=5; partially_supported=2 |  | 2021 incomplete Korean data, unbalanced controls, and unavailable causal covariates | 2022년 고점 이후 거래기반 약화 관측; 구조적 쇠퇴 원인은 식별 불가 | medium |
